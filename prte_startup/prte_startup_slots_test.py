...
@rfm.simple_test
class PrteStartupSlotsTest(rfm.RunOnlyRegressionTest):
    ...
    sourcesdir = '.'
    executable = './prte_startup_slots_test.sh'

    executable_opts = [str(node_count), str(num_trials), str(slots_per_node)]

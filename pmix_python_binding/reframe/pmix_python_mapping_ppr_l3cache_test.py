...
class PMIxPythonMappingPPRL3CacheTest(
    ...
    def prepare_test(self):
        ...
        self.prerun_cmds = [
            f'cp {os.path.join(SUITE_DIR, "wrappers", "run_pmix_python_mapping_ppr_l3cache_test.sh")} .',
            f'cp {os.path.join(SUITE_DIR, "workloads", "spawn_mapping_ppr_l3cache_test.py")} .'
        ]
